...
Supports public defaults plus optional custom mirrored hosts from environment variables.
"""
...
class HyperliquidEndpointRouter:
    ...
    PROVIDER_PRIORITIES = {
        ...
        EndpointType.EXCHANGE: [Provider.PUBLIC],
        EndpointType.EVM: [
            Provider.CUSTOM,
            Provider.PUBLIC,
        ],
    ...
    def _load_endpoints_from_env(self) -> None:
        ...
        endpoint_mappings = [
            ...
            ("CUSTOM_INFO_URL", Provider.CUSTOM, EndpointType.INFO),
            ("CUSTOM_EVM_URL", Provider.CUSTOM, EndpointType.EVM),
            ("CUSTOM_WS_URL", Provider.CUSTOM, EndpointType.WEBSOCKET),
        ]
